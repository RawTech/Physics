...
public class Impact extends java.applet.Applet {
	...
	public boolean action(Event e,Object arg) {
		if (e.target instanceof Button && arg.equals("Start")) {
			b = new MainWindow("RawTech Physics", true);
			b.resize(640,480);
			b.show();
			b.start();
		}
	...
	private void begin() {
		b = new MainWindow("RawTech Physics", false);
		b.resize(640,480);
		b.show();
		b.start();
	}
...
class Animator extends Canvas implements Runnable {
	...
	Animator(Ticker t, Panel p) {
		...
		addBall(new Ball(150,10,Color.yellow,200,200,0,0));
		addBall(new Ball(16,4,Color.cyan,250,200,0,4));
		my = -17;	    // mouse up
	}
